...
print ("Framework: ", (time.time()-t), objective(pdhg.get_output()) )

print ("running regularisers")
t = time.time()
reg = FGP_TV(alpha, pdhg.max_iteration, 1e-6, 0, 0, 0, 'cpu')
a = reg.prox(noisy_data, 1. )
print ("Regularisation: ", (time.time()-t), objective(a))
...
if not cvx_installable or True:
